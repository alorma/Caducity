...
sealed interface CreateCategoryNavigation {
  ...
  data class CategoryCreated(val categoryId: String) : CreateCategoryNavigation
}

sealed interface CreateCategoryNavigationSideEffect {
  data object NavigateBack : CreateCategoryNavigationSideEffect
  data class NavigateToCategoryDetail(val categoryId: String) : CreateCategoryNavigationSideEffect
}
